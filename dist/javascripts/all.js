    ...
    function s(o, u) {
      ...
      var EventPluginHub = {
        ...
        putListener: function putListener(id, registrationName, listener) {
          !(typeof listener === 'function') ? "development" !== 'production' ? invariant(false, 'Expected %s listener to be a function, instead got type %s', registrationName, typeof listener === "undefined" ? "undefined" : _typeof(listener)) : invariant(false) : undefined;
      ...
      function mergeIntoWithNoDuplicateKeys(one, two) {
        !(one && two && (typeof one === "undefined" ? "undefined" : _typeof(one)) === 'object' && (typeof two === "undefined" ? "undefined" : _typeof(two)) === 'object') ? "development" !== 'production' ? invariant(false, 'mergeIntoWithNoDuplicateKeys(): Cannot merge non-objects.') : invariant(false) : undefined;
      ...
      var ReactClass = {
        ...
        createClass: function createClass(spec) {
          var Constructor = function Constructor(props, context, updater) {
            ...
            !((typeof initialState === "undefined" ? "undefined" : _typeof(initialState)) === 'object' && !Array.isArray(initialState)) ? "development" !== 'production' ? invariant(false, '%s.getInitialState(): must return an object or null', Constructor.displayName || 'ReactCompositeComponent') : invariant(false) : undefined;
      ...
      ReactComponent.prototype.setState = function (partialState, callback) {
        !((typeof partialState === "undefined" ? "undefined" : _typeof(partialState)) === 'object' || typeof partialState === 'function' || partialState == null) ? "development" !== 'production' ? invariant(false, 'setState(...): takes an object of state variables to update or a ' + 'function which returns an object of state variables.') : invariant(false) : undefined;
        if ("development" !== 'production') {
      ...
      var ReactCompositeComponentMixin = {
        ...
        mountComponent: function mountComponent(rootID, transaction, context) {
          ...
          !((typeof initialState === "undefined" ? "undefined" : _typeof(initialState)) === 'object' && !Array.isArray(initialState)) ? "development" !== 'production' ? invariant(false, '%s.state: must be set to an object or null', this.getName() || 'ReactCompositeComponent') : invariant(false) : undefined;
        ...
        _processChildContext: function _processChildContext(currentContext) {
          ...
          if (childContext) {
            !(_typeof(Component.childContextTypes) === 'object') ? "development" !== 'production' ? invariant(false, '%s.getChildContext(): childContextTypes must be defined in order to ' + 'use getChildContext().', this.getName() || 'ReactCompositeComponent') : invariant(false) : undefined;
            if ("development" !== 'production') {
      ...
      function assertValidProps(component, props) {
        ...
        if (props.dangerouslySetInnerHTML != null) {
          ...
          !(_typeof(props.dangerouslySetInnerHTML) === 'object' && HTML in props.dangerouslySetInnerHTML) ? "development" !== 'production' ? invariant(false, '`props.dangerouslySetInnerHTML` must be in the form `{__html: ...}`. ' + 'Please visit https://fb.me/react-invariant-dangerously-set-inner-html ' + 'for more information.') : invariant(false) : undefined;
        }
        if ("development" !== 'production') {
        ...
        !(props.style == null || _typeof(props.style) === 'object') ? "development" !== 'production' ? invariant(false, 'The `style` prop expects a mapping from style properties to values, ' + 'not a string. For example, style={{marginRight: spacing + \'em\'}} when ' + 'using JSX.%s', getDeclarationErrorAddendum(component)) : invariant(false) : undefined;
      }
      ...
      function instantiateReactComponent(node) {
        ...
        if (node === null || node === false) {
          ...
          var element = node;
          !(element && (typeof element.type === 'function' || typeof element.type === 'string')) ? "development" !== 'production' ? invariant(false, 'Element type is invalid: expected a string (for built-in components) ' + 'or a class/function (for composite components) but got: %s.%s', element.type == null ? element.type : _typeof(element.type), getDeclarationErrorAddendum(element._owner)) : invariant(false) : undefined;
          ...
          !false ? "development" !== 'production' ? invariant(false, 'Encountered invalid React node of type %s', typeof node === "undefined" ? "undefined" : _typeof(node)) : invariant(false) : undefined;
        }
      ...
      */
      ...
      function toArray(obj) {
        ...
        !(!Array.isArray(obj) && ((typeof obj === "undefined" ? "undefined" : _typeof(obj)) === 'object' || typeof obj === 'function')) ? "development" !== 'production' ? invariant(false, 'toArray: Array-like object expected') : invariant(false) : undefined;
...
onReady(function () {
    ReactDOM.render(React.createElement(TodoApp), document.getElementById("hello"));
});
"use strict";
...
var AddItem = function (_React$Component) {
    ...
    function AddItem(props) {
        ...
        _this.updateItemName = _this.updateItemName.bind(_this);
    ...
    _createClass(AddItem, [{
        key: "updateItemName",
        value: function updateItemName(itemName) {
            this.setState({
                itemName: itemName
            });
        }
        ...
        value: function render() {
            return React.createElement(
                "div",
                { className: "add-item" },
                React.createElement(AddItemNameInput, { itemName: this.state.itemName, onChange: this.updateItemName }),
                React.createElement(AddItemButton, { disabled: this.state.itemName.length === 0, onClick: this.addItem })
            );
        }
    }]);
...
var AddItemButton = function (_React$Component) {
    _inherits(AddItemButton, _React$Component);

    function AddItemButton(props) {
        _classCallCheck(this, AddItemButton);

        var _this = _possibleConstructorReturn(this, (AddItemButton.__proto__ || Object.getPrototypeOf(AddItemButton)).call(this, props));
    ...
    _createClass(AddItemButton, [{
        ...
        value: function render() {
            return React.createElement(
                "button",
                { className: "add-item-button", disabled: this.props.disabled, onClick: this.handleClick },
                "Add Item"
            );
        }
    }]);
...
var AddItemNameInput = function (_React$Component) {
    _inherits(AddItemNameInput, _React$Component);

    function AddItemNameInput(props) {
        _classCallCheck(this, AddItemNameInput);

        var _this = _possibleConstructorReturn(this, (AddItemNameInput.__proto__ || Object.getPrototypeOf(AddItemNameInput)).call(this, props));
    ...
    _createClass(AddItemNameInput, [{
        ...
        key: "render",
        value: function render() {
            return React.createElement("input", { className: "add-item-input", placeholder: "Item Name", type: "text", value: this.props.itemName, onChange: this.handleChange });
        }
    }]);

    return AddItemNameInput;
}(React.Component);
"use strict";
...
var DeleteItemButton = function (_React$Component) {
    _inherits(DeleteItemButton, _React$Component);

    function DeleteItemButton(props) {
        _classCallCheck(this, DeleteItemButton);

        var _this = _possibleConstructorReturn(this, (DeleteItemButton.__proto__ || Object.getPrototypeOf(DeleteItemButton)).call(this, props));
    ...
    _createClass(DeleteItemButton, [{
        ...
        value: function render() {
            return React.createElement(
                "button",
                { className: "delete-item-button", onClick: this.handleClick },
                "\xD7"
            );
        }
    }]);
    ...
    _createClass(Item, [{
        ...
        value: function render() {
            return React.createElement(
                ...
                React.createElement(DeleteItemButton, { onClick: this.delete })
            );
        }
    }]);
        ...
        value: function render() {
            ...
            items = this.props.items.map(function (self) {
                return function (itemName, index) {
                    return React.createElement(Item, { itemName: itemName, index: index, onDelete: self.deleteItem, key: "todo-item-" + index.toString() });
                };
            }(this));
    ...
    _createClass(TodoApp, [{
        ...
        value: function render() {
            ...
            return React.createElement(
                ...
                React.createElement(AddItem, { onAddItem: this.addItem }),
                React.createElement(ItemList, { items: this.state.items, onDeleteItem: this.deleteItem })
            );
        }
    }]);
